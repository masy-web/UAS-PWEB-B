    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><?= $data['title'] ?></h3> <div class="btn-group float-right"><a href="<?= base_url; ?>/hewan/tambah" class="btn float-right btn-xs btn btn-primary">Tambah Data Hewan</a><!-- <a href="<?= base_url; ?>/hewan/laporan" class="btn float-right btn-xs btn btn-info">Laporan Data Hewan</a> --><a href="<?= base_url; ?>/hewan/lihatlaporan" class="btn float-right btn-xs btn btn-warning">Lihat Laporan Data Hewan</a></div>
        </div>
        <div class="card-body">
